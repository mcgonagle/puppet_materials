...
; $Id: php.ini-allpurpose.tpl,v 1.10 2010/06/05 12:57:22 rbraun Exp $
; Sourced from php.ini-recommended in php distribution tarball
; Puppetized by wflynn 10/2009
...
; Allow ASP-style \<\% \%\> tags (escaped, because these are ERB style tags too).
asp_tags=Off
...
memory_limit=<%= memory_limit %>      ; Maximum amount of memory a script may consume (128MB)
...
; Log errors to specified file or syslog (see below).
error_log=<%= error_log %>
...
; Zend Extensions
<% zend_extensions.each do |zend_extension| -%>
...
odbc.allow_persistent=<%= odbc_allow_persistent %>

; Check that a connection is still valid before reuse.
odbc.check_persistent=<%= odbc_check_persistent %>

; Maximum number of persistent links.  -1 means no limit.
odbc.max_persistent=<%= odbc_max_persistent %>

; Maximum number of links (persistent + non-persistent).  -1 means no limit.
odbc.max_links=<%= odbc_max_links %>

; Handling of LONG fields.  Returns number of bytes to variables.  0 means
; passthru.
odbc.defaultlrl=<%= odbc_defaultlrl %>

; Handling of binary data.  0 means passthru, 1 return as is, 2 convert to char.
; See the documentation on odbc_binmode and odbc_longreadlen for an explanation
; of uodbc.defaultlrl and uodbc.defaultbinmode
odbc.defaultbinmode=<%= odbc_defaultbinmode %>

[MySQL]
; Allow or prevent persistent links.
mysql.allow_persistent=<%= mysql_allow_persistent %>

; Maximum number of persistent links.  -1 means no limit.
mysql.max_persistent=<%= mysql_max_persistent %>

; Maximum number of links (persistent + non-persistent).  -1 means no limit.
mysql.max_links=<%= mysql_max_links %>

; Default port number for mysql_connect().  If unset, mysql_connect() will use
; the $MYSQL_TCP_PORT or the mysql-tcp entry in /etc/services or the
; compile-time value defined MYSQL_PORT (in that order).  Win32 will only look
; at MYSQL_PORT.
mysql.default_port=<%= mysql_default_port %>

; Default socket name for local MySQL connects.  If empty, uses the built-in
; MySQL defaults.
mysql.default_socket=<%= mysql_default_socket %>

; Default host for mysql_connect() (doesn't apply in safe mode).
mysql.default_host=<%= mysql_default_host %>

; Default user for mysql_connect() (doesn't apply in safe mode).
mysql.default_user=<%= mysql_default_user %>
...
mysql.default_password=<%= mysql_default_password %>

; Maximum time (in seconds) for connect timeout. -1 means no limit
mysql.connect_timeout=<%= mysql_connect_timeout %>

; Trace mode. When trace_mode is active (=On), warnings for table/index scans and
; SQL-Errors will be displayed.
mysql.trace_mode=<%= mysql_trace_mode %>

[MySQLi]

; Maximum number of links.  -1 means no limit.
mysqli.max_links=<%= mysqli_max_links %>

; Default port number for mysqli_connect().  If unset, mysqli_connect() will use
; the $MYSQL_TCP_PORT or the mysql-tcp entry in /etc/services or the
; compile-time value defined MYSQL_PORT (in that order).  Win32 will only look
; at MYSQL_PORT.
mysqli.default_port=<%= mysqli_default_port %>

; Default socket name for local MySQL connects.  If empty, uses the built-in
; MySQL defaults.
mysqli.default_socket=<%= mysqli_default_socket %>

; Default host for mysql_connect() (doesn't apply in safe mode).
mysqli.default_host=<%= mysqli_default_host %>

; Default user for mysql_connect() (doesn't apply in safe mode).
mysqli.default_user=<%= mysqli_default_user %>
...
; and reveal this password!  And of course, any users with read access to this
; file will be able to reveal the password as well.
mysqli.default_pw=<%= mysqli_default_pw %>

; Allow or prevent reconnect
mysqli.reconnect=<%= mysqli_reconnect %>
...
; This option enables a	dministrators to make their users invulnerable to
...
tidy.clean_output=<%= tidy_clean_output %>
...
[apc]
; APC Cache settings
; TFM here: http://www.php.net/manual/en/apc.configuration.php
apc.enabled=<%= apc_enabled %>
apc.shm_segments=<%= apc_shm_segments %>
apc.shm_size=<%= apc_shm_size %>
apc.optimization=<%= apc_optimization %>
...
apc.mmap_file_mask=<%= apc_file_mask %>
...
apc.localcache=<%= apc_localcache %>
apc.localcache.size=<%= apc_localcache_size %>
apc.coredump_unmap=<%= apc_coredump_unmap %>
