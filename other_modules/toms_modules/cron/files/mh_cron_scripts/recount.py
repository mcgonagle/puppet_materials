...
msgdb1 = MySQLdb.connect(host="maildb02",user="apache",passwd="LQSyM",db="messages")
main(msgdb1)
msgdb2 = MySQLdb.connect(host="mail-db25-49",user="apache",passwd="LQSyM",db="messages")
main(msgdb2)
