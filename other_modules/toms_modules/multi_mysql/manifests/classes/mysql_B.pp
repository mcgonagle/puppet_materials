class multi_mysql::mysql_B inherits multi_mysql {

 $mysql_tar_ball = "mysql-enterprise-gpl-5.1.48-linux-x86_64-glibc23"
 $mysql_instance = "mysql_B"
...
}#end of class multi_mysql::mysql_B
